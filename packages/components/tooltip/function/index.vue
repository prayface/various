<template>
    <div class="ui-tooltip-container" :class="{ 'ui-active': active }">
...
//* 资源引入
import { UiTooltipFunctionPropsOption, UiTooltipFunctionEmits } from "./index";
import { useComposable } from "./src/composable";

//* 获取组件属性
const emits = defineEmits(UiTooltipFunctionEmits);
