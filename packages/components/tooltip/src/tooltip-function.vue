<template>
    <div v-bind="$attrs" class="ui-tooltip-container" ref="main">
...
import { UiTooltipFunctionPropsOption } from "./tooltip";
import Composable, { UiTooltipConstructorRefs } from "./composable.function";

export default defineComponent({
    name: "UiTooltipFunction",
