<template>
    <div class="textarea">
        <section>
            ...
            <div class="content">
                <UiButton @click="$refs.modal.openModal()">开启模态框</UiButton>
                <UiModal ref="modal" title="模拟标题">
                    <p>测试模态框</p>
                    <p>测试模态框</p>
                    <p>测试模态框</p>
                    <p>测试模态框</p>
        ...
        <section>
            ...
            <div class="descript">从顶部出现, 3秒后自动消失。</div>
            <div class="content">
                <UiButton @click="$refs.modal2.openModal()">开启模态框</UiButton>
                <UiModalSemiScreen ref="modal2">
                    <p>测试模态框</p>
                    <p>测试模态框</p>
                    <p>测试模态框</p>
                    <p>测试模态框</p>
